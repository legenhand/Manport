...
$page2 = '
	...
	<table border="1" cellspacing="" cellpadding="4">
		<tr style="background-color: #D4F2DB">
			<th rowspan="2" width="25"><br><br>No</th>
			<th rowspan="2" width="100"><br><br>Mata pelajaran</th>
			
			<th colspan="3" width="200" align="center">Pengetahuan</th>
			<th colspan="3" width="200" align="center">Keterampilan</th>
		</tr>
		<tr style="background-color: #D4F2DB">
...
if($cek_has_nilai_deskripsi > 0) {
    ...
    foreach($nilai_deskripsi as $d) {
        if($kelompok_sebelum != $d['kelompok_mapel']) {
            ...
            $page2 .= '<tr>
					<th colspan="8">Kelompok '.$d['kelompok_mapel'].'</th>
				</tr>';
        }

        $kd_x = [
            "Matematika" => "",
            "Bahasa Inggris & Bahasa Asing lainnya" => "Memahami Narrative recount text",
            "Bahasa Inggris & Bahasa Asing lainnya " => "Memahami Narrative recount text",
            ...
            "Sejarah Indonesia" => "perkembangan politik dan ekonomi Indonesia pada masa awal kemerdekaan hingga Demokrasi Terpimpin",
            "Pendidikan Pancasila & Kewarganegaraan" => "Memahami Pembelajaran",
            "Seni Budaya" => "Memahami konsep budaya dan Memahami konsep seni",
            "Seni Budaya " => "Memahami konsep budaya dan Memahami konsep seni",
            ...
            "Komputer dan Jaringan Dasar" => "Menganalisis Permasalahan pada jaringan lokal (LAN)",
            "Pemrograman Dasar" => "Memahami algoritma pemrograman",
            "Dasar Design Grafis" => "Perangkat lunak berbasis vektor ",
            "Sistem Komputer" => "Memahami Pembelajaran",
            "Bahasa Sunda" => "menganalisis isi struktur dan aspek kebahasaan teks wawancara",
            ...
            "Perencanaan Bisnis" => "menerapkan model pengelolaan kegiatan/event  ",
            "Marketing" => "Memahami Pembelajaran",
            "IPA" => "Sumber daya alam",
            "Korespondensi" => "cara  lipatan surat, membuat kop surat, alamat dalam,salam pembuka,alinea pembuka surat,macam-macam surat dinas",
        ...
        $kd_xi = [
            ...
            "Pendidikan Pancasila & Kewarganegaraan" => "Sistem Hukum di Indonesia dan sistem perlindungan Tenaga kerja di Indonesia",
            "Pendidikan Jasmani Olahraga & Kesehatan" => "Memahami Pembelajaran",
            "Administrasi Sistem Jaringan" => "sistem operasi jaringan, Menginstalasi sistem operasi jaringan",
            "Teknologi Layanan Jaringan" => "Karakteristik ragam aplikasi komunikasi data",
            "Administrasi Infrastruktur Jaringan" => "permasalahan routing statis",
            "Teknologi Jaringan Berbasis Luas (WAN)" => "Jaringan fiber optic",
            "Produk Kreatif dan Kewirausahaan" => "Administrasi Usaha",
            "Penataan Produk" => "Memahami Pembelajaran",
            "Pengelolaan Bisnis Ritel" => "Undang Undang perlindungan konsumen",
            "Administrasi Transaksi" => "mencatat bukti transaksi pengeluaran kas, mesin pembayaran dalam transaksi, mengoperasional alat hitung dan mengoperasionalkan mesin pembayaran tunai/non tunai",
            "Bisnis Online" => "Merancang iklan online, Menerapkan pembuatan Blog",
            "Otomatisasi Tata Kelola Sarana Prasarana" => "Memahami Pembelajaran",
            "Otomatisasi Tata Kelola Humas Keprotokolan" => "Memahami Pembelajaran",
            "Otomatisasi Tata Kelola Kepegawaian" => "pembuatan daftar urut kepangkatan,pengembangan karier pegawai",
            "Otomatisasi Tata Kelola Keuangan" => "Pengelolaan administrasi keuangan",
        ];
        ...
        $page2 .= '<tr>
				...
				<td align="center">'.$no.'</td>
				<td>'.$d['nama_mapel'].'</td>
				<td align="center">'.$d['nilai_p'].'</td>
				<td align="center">'.$predikat_p.'</td>
				<td align="justify" style="font-size: 10px">'.$deskripsi_p. $kd[$d['nama_mapel']] .'</td>
				<td align="center">'.$d['nilai_k'].'</td>
				<td align="center">'.$db->generate_predikat($d['nilai_k'], $d['predikat_d'], $d['predikat_c'], $d['predikat_b'], $d['predikat_a']).'</td>
